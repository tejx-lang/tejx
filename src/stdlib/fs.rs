use crate::runtime::{
    __resolve_promise, Array_push, HEAP, Promise_new, TaggedValue, a_new, stringify_value,
};
...
// --- Async Wrappers ---
// These are synchronous but return a resolved Promise.
